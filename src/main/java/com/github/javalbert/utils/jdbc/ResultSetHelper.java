...
public class ResultSetHelper implements ResultSet {
	...
	public Boolean getBoolean2(int columnIndex) throws SQLException {
		boolean x = getBoolean(columnIndex);
		return !x && rs.wasNull() ? null : x;
	}
	
	public Boolean getBoolean2(String columnLabel) throws SQLException {
		boolean x = getBoolean(columnLabel);
		return !x && rs.wasNull() ? null : x;
	}
	
	public Byte getByte2(int columnIndex) throws SQLException {
		byte x = getByte(columnIndex);
		return x == 0 && rs.wasNull() ? null : x;
	}
	
	public Byte getByte2(String columnLabel) throws SQLException {
		byte x = getByte(columnLabel);
		return x == 0 && rs.wasNull() ? null : x;
	}
	 ...
	 * 
	 * @param columnIndex
	 * @return java.util.Date instead of java.sql.Date
	 * @throws SQLException
	 */
	public java.util.Date getDate2(int columnIndex) throws SQLException {
	 ...
	 * @throws SQLException
	 */
	public java.util.Date getDate2(String columnLabel) throws SQLException {
		Date x = getDate(columnLabel);
		return x != null ? new java.util.Date(x.getTime()) : null;
	}
	
	public Double getDouble2(int columnIndex) throws SQLException {
		double x = getDouble(columnIndex);
		return x == 0 && rs.wasNull() ? null : x;
	}
	
	public Double getDouble2(String columnLabel) throws SQLException {
		double x = getDouble(columnLabel);
		return x == 0 && rs.wasNull() ? null : x;
	}
	
	public Float getFloat2(int columnIndex) throws SQLException {
		float x = getFloat(columnIndex);
		return x == 0 && rs.wasNull() ? null : x;
	}
	
	public Float getFloat2(String columnLabel) throws SQLException {
		float x = getFloat(columnLabel);
		return x == 0 && rs.wasNull() ? null : x;
	}
	
	public Integer getInt2(int columnIndex) throws SQLException {
		int x = getInt(columnIndex);
		return x == 0 && rs.wasNull() ? null : x;
	}
	...
	public Long getLong2(int columnIndex) throws SQLException {
		long x = getLong(columnIndex);
		return x == 0 && rs.wasNull() ? null : x;
	}
	
	public Long getLong2(String columnLabel) throws SQLException {
		long x = getLong(columnLabel);
		return x == 0 && rs.wasNull() ? null : x;
	}
	
	public Short getShort2(int columnIndex) throws SQLException {
		short x = getShort(columnIndex);
		return x == 0 && rs.wasNull() ? null : x;
	}
	
	public Short getShort2(String columnLabel) throws SQLException {
		short x = getShort(columnLabel);
		return x == 0 && rs.wasNull() ? null : x;
	}
	...
	/* END ResultSet interface methods */
}